		...
		<div class="tab-content jump">
			<div class="tab-pane active">
				<div class="row">
					...
					$newProductsBeforeFetch = $newProducts->selectNewProducts();
					if ($newProductsBeforeFetch) {
						$newProductsAfterFetch = $newProductsBeforeFetch->fetch_all(MYSQLI_ASSOC);
					}
					if (isset($newProductsAfterFetch)) {
						foreach ($newProductsAfterFetch as $key => $newProduct) {
					?>
							<div class="col-3">
								<div class="product-wrapper mb-30">
									<div class="product-img">
										<a href="product-details.php?pr=<?= $newProduct['id'] ?>">
											<img width="268" height="288" alt="" src="assets/img/product/<?=$newProduct['image']?>">
										</a>
									...
									<div class="product-content text-center">
										<div class="product-hover-style">
											<div class="product-title">
												<h4>
													<a href="product-details.php?pr=<?= $newProduct['id'] ?>"> <?= $newProduct['name'] ?> </a>
												</h4>
											</div>
										</div>
										<div class="product-price-wrapper">
											<span> <?= $newProduct['price'] ?> EGP</span>
										</div>
									</div>
								</div>
							</div>
	...
	<div class="container">
		...
		<div class="tab-content jump">
			<div class="tab-pane active">
				<div class="row">
					<?php
					// select most rated products
					$mostRatedProducts = new Product;
					$mostRatedProductsBeforeFetch = $mostRatedProducts->selectMostRatedProducts();
					if ($mostRatedProductsBeforeFetch) {
						$mostRatedProductsAfterFetch = $mostRatedProductsBeforeFetch->fetch_all(MYSQLI_ASSOC);
					}
					if (isset($mostRatedProductsAfterFetch)) {
						foreach ($mostRatedProductsAfterFetch as $key => $mostRatedProduct) {
					?>
							<div class="col-3">
								<div class="product-wrapper mb-30">
									<div class="product-img">
										<a href="product-details.php?pr=<?= $mostRatedProduct['id'] ?>">
											<img width="268" height="288" alt="" src="assets/img/product/<?=$mostRatedProduct['image']?>">
										</a>
										<div class="product-action">
											<a class="action-wishlist" href="#" title="Wishlist">
												<i class="ion-android-favorite-outline"></i>
									...
									<div class="product-content text-center">
										<div class="product-hover-style">
											<div class="product-title">
												<h4>
													<a href="product-details.php?pr=<?= $mostRatedProduct['id'] ?>"> <?= $mostRatedProduct['name'] ?> </a>
												</h4>
											</div>
										</div>
										<div class="product-price-wrapper">
											<span> <?= $mostRatedProduct['price'] ?> EGP</span>
										</div>
									</div>
								</div>
							</div>
